              ...
              <div className="flex items-center mr-3">
                {!sidebar && (
                  <div className="w-14 h-14 mr-3 relative group flex-shrink-0">
                    <img src={current.image} alt="" className="rounded-lg" />
                    <button
        ...
        <div className="max-w-[45.125rem] w-[40%] pt-2 flex flex-col px-4 items-center">
          <div className="flex items-center gap-x-2">
            ...
            <button
              ...
              className={`w-8 h-8 flex items-center justify-center ${state.playing ? "bg-primary" : "bg-white"} ${state.playing ? "text-white" : "text-black"} rounded-full hover:scale-[1.06]`}>
